...
host-test: signature-check
	...
	python3 -m unittest tests/test_analyze_bootblock.py tests/test_qualify_signature.py tests/test_build_clean_manifest.py tests/test_promote_signature.py tests/test_preflight_signature.py tests/test_identify_known_bootblock.py
