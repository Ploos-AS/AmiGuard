...
TARGET := AmiGuard
SRC := src/main.c src/scanner.c src/signatures.c src/trackdisk.c src/hunk.c src/file_intake.c src/file_signatures.c src/xvs_bridge.c src/disk_scanner.c src/volume_scanner.c src/image_scanner.c
OBJ := $(SRC:.c=.o)
