...
def execute(run):
    ...
    try:
        ...
        time.sleep(3)
        stage('clean')
        require('clean', 'KNOWN: Amiga DOS bootblock', 0)
        ...
        for i in range(1, 11):
            ...
            if 'KNOWN: Amiga DOS bootblock' not in output or 'read 1024 bytes at offset 0' not in output or 'previous-rc=0\n' not in probe:
        ...
        result = {'completed_log_checks': completed, 'media_after': after,
