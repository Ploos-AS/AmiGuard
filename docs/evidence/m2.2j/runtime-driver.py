...
def execute(run):
    ...
    try:
        ...
        for name, expected, code in [('positive','TEST-SIGNATURE: EICAR Standard Anti-Virus Test File',0),('nearmiss','NOT-HUNK:',0),('filevalid','VALID-HUNK:',0),('fileplain','NOT-HUNK:',0),('filemalformed','MALFORMED-HUNK:',0),('fileoversize','ERROR: file exceeds 128 KiB M2.1 limit',20),('filemissing','ERROR: cannot open file read-only',20)]:
            stage(name)
...
if __name__ == '__main__':
    execute(Path('/tmp/amiguard-m22j-run'))
