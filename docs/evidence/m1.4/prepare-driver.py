...
a=argparse.Namespace(**{k:Path(v) for k,v in old['inputs'].items()},run_dir=Path('/tmp/amiguard-m14-run'),cc='/opt/amiga/bin/m68k-amigaos-gcc',xdftool='/tmp/amiguard-m03-tools/bin/xdftool')
r=m.prepare(a)
